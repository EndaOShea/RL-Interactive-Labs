...
// SCALE-FREE (like generate): grade off a recomputed cosine of the query vs the top
// chunk, NOT `ranked[0].score` (a BM25/RRF value under sparse/hybrid → would misgrade
// every query). high ⇒ correct; very low ⇒ incorrect; between ⇒ ambiguous.
